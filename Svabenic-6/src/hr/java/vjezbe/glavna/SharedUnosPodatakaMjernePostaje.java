...
public class SharedUnosPodatakaMjernePostaje {
    ...
    public static MjernaPostaja unesiMjernuPostaju(Scanner skener, Integer redniBroj, Mjesto mjesto,
                                                   GeografskaTocka geografskaTocka, List<Senzor> senzori, MjernePostaje<MjernaPostaja> postaje) {
     ...
     */
    public static Zupanija unesiZupaniju(Scanner skener, Integer redniBroj, Drzava drzava, MjernePostaje<MjernaPostaja> postaje) {
    ...
    public static Mjesto unesiMjesto(Scanner skener, Integer redniBroj, Zupanija zupanija, MjernePostaje<MjernaPostaja> postaje) {
