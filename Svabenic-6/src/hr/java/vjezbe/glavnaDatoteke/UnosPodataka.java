...
public class UnosPodataka {
    ...
    public static Map<Integer, Drzava> dohvatiDrzave(){
        ...
        return drzavaDatoteka;
    }

    public static Map<Integer, Zupanija> dohvatiZupanije(){
        List<String> lista = new ArrayList<>();
        Integer id = 0;
        String naziv = "";
        Drzava drzava = null;
        ...
        return zupanijaDatoteka;
    }

    public static Map<Integer, Mjesto> dohvatiMjesta(){
        List<String> lista = new ArrayList<>();
        Integer id = 0;
        String naziv = "";
        ...
        return mjestoDatoteka;
    }

    public static Map<Integer, GeografskaTocka> dohvatiTocke(){
        List<String> lista = new ArrayList<>();
        Integer id = 0;
        ...
        return tockaDatoteka;
    }

    public static Map<Integer, Senzor> dohvatiSenzore(){
        List<String> lista = new ArrayList<>();
        Integer id = 0;
        String sifra = "";
        ...
        return senzorDatoteka;
    }

    public static Map<Integer, MjernaPostaja> dohvatiPostaje(){
        List<String> lista = new ArrayList<>();
        Integer id = 0;
        String naziv = "";
        Mjesto mjesto = null;
        ...
        return postajaDatoteka;
    }

    public static Map<Mjesto, List<Senzor>> dohvatiMjestaISenzore(){
        Map<Mjesto, List<Senzor>> mjestaSenzori = new HashMap<>();
        List<Senzor> senzors = new ArrayList<>(senzorDatoteka.values());
        for (Mjesto mjesto: mjestoDatoteka.values()) {
            mjestaSenzori.put(mjesto, senzors);
        }
        return mjestaSenzori;
    }

    private static void citanjeDatoteke(List<String> listaEntiteta, String file){
    ...
    public static void dohvatiPodatkeZaIspis(){
        dohvatiDrzave();
        dohvatiZupanije();
        dohvatiMjesta();
        dohvatiTocke();
